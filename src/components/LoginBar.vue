        ...
        <nav id="sidebar">
          <div class="sidebar-header">
              <b-col md="12">
                  ...
                  <p class="welcomeText mt-3">Não tem conta?</p>
                  <router-link class="menuItems" :to="{ name: 'register' }"><button class="registerBtn">Registar-me</button></router-link>
              </b-col>
          </div>
...
#sidebar ul li .menuItems:hover {
  color: #747883;
  background-color: #EFEFEF;
  border-left: 3px solid #c74620;
}
